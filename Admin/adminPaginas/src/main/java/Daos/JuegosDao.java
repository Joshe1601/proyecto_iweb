...
public class JuegosDao {
    ...
    public ArrayList<Juegos> obtenerListaJuegosPosteados(){
        try {
        ...
        ArrayList<Juegos> listaJuegosPosteados = new ArrayList<>();
        try (Connection conn = DriverManager.getConnection(url, user, pass);
            ...
            while (rs.next()) {
                ...
                listaJuegosPosteados.add(new Juegos(nombre,genero,precio,imagen));
            }
